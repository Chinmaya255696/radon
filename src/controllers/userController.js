...
const bkProduct = async function (req,res){
...
const recordsOfAll= async function(req,res){
    let data = req.body
    let savedData = await Records.create(data)
    res.send({ msg: savedData})
}
module.exports.User = User
 module.exports.bkProduct = bkProduct
module.exports.recordsOfAll = recordsOfAll
